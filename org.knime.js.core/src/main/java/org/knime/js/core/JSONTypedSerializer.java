...
public abstract class JSONTypedSerializer<T> extends StdSerializer<T> {
     ...
     * @param t  
     */
    protected JSONTypedSerializer(final Class<T> t) {
        super(t);
    }
    
    /** {@inheritDoc} */
    @Override
    public final void serializeWithType(final T value, final JsonGenerator jgen, final SerializerProvider provider,
