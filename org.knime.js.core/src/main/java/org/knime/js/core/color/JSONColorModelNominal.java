 ...
 */
@JsonAutoDetect
public class JSONColorModelNominal extends JSONColorModel {
    private static final String CFG_LABELS = "labels";
    ...
    public void saveToNodeSettings(final NodeSettingsWO settings) {
        ...
        settings.addStringArray(CFG_LABELS, getLabels());
    ...
    public void loadFromNodeSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        setLabels(settings.getStringArray(CFG_LABELS));
    ...
    public void loadFromNodeSettingsInDialog(final NodeSettingsRO settings) {
        ...
        setLabels(settings.getStringArray(CFG_LABELS, (String[])null));
    ...
    public boolean equals(final Object obj) {
        ...
        JSONColorModelNominal other = (JSONColorModelNominal)obj;
