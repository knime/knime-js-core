 ...
 * their interactive view by means of JSON serializable request and response objects.
 *
 ...
 * @since 3.7
 */
public interface JSONViewRequestHandler<REQ extends JSONViewRequest, RES extends JSONViewResponse<REQ>>
    extends WizardViewRequestHandler<REQ, RES> {

    /*
     * no further methods declared, just restricts generics
     * inherits 'RES handleRequest(REQ request)'
     */
