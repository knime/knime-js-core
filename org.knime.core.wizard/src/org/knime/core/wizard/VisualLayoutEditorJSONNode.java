...
class VisualLayoutEditorJSONNode {
    ...
    /**
     * Subnode layout legacy mode flag designating if the legacy mode flag is enabled on the subnode container layout or
     * not. This flag does not affect whether legacy mode is actually used in the subnode container layout; it's only
     * used to visually identify nested subnodes in the parent layout which are using the legacy mode flag while viewing
     * the layout in the Visual Layout Editor.
     *
     * @since 4.2
     */
