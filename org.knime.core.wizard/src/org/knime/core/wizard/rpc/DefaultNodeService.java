...
public class DefaultNodeService implements NodeService {
    ...
    // TODO what is the authentication here?
    private final CodeKaiHandler m_codeKaiHandler = KaiHandlerFactoryRegistry.createCodeKaiHandler(null).orElse(null);
