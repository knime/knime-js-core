...
public class JSCoreCompositeViewDataProvider implements CompositeViewDataProvider {
    ...
    private static final NodeLogger LOGGER = NodeLogger.getLogger(JSCoreCompositeViewDataProvider.class);
    ...
    public String getCompositeViewData(final SubNodeContainer snc,
        ...
        var pageCreationHelper = (WizardPageCreationHelper)nnc -> createNodeViewEntity.apply(nnc);
