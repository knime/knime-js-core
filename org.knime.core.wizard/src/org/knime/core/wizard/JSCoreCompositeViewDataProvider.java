...
public class JSCoreCompositeViewDataProvider implements CompositeViewDataProvider {
    ...
    public String getCompositeViewData(final SubNodeContainer snc,
        ...
        WizardPageCreationHelper pageCreationHelper = createNodeViewEntity::apply;

        model.createPageAndValue(pageCreationHelper);
    ...
    public void reexecutePage(final SubNodeContainer snc, final String nodeIdThatTriggered,
        ...
        if (model.canTriggerReExecution() != true) {
            System.out.println("Not triggerable? Why?");
        }
        model.createReexecutionService((WizardPageCreationHelper)nnc -> createNodeViewEnt.apply(nnc))
