...
public class DefaultNodeServiceTest {
    ...
    public void testSelectDataPoints() {
        ...
        new DefaultNodeService(m_nnc).updateDataPointSelection("ignored", "ignored", "ignored", "nodeId",
    ...
    public void testSelectDataPointsInComponentView() throws Exception {
        ...
        try (var dispose = setupSelectionEvents(selectionEventConsumer, component)) {
            nodeService.updateDataPointSelection("ignored", "ignored", "ignored", "root:5:0:4", ADD.toString(),
